        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex flex-wrap items-center gap-2 mb-4">
            ...
            <div className="flex items-center ml-2">
              ...
              <span className="ml-1 text-gray-500">({course.totalRatings})</span>
            </div>
          </div>
        ...
        {navItems.map((item) => (
          <button
            ...
            className={`relative z-10 px-6 py-3 rounded-full font-medium transition-colors duration-300 ${
              activeIndex === item.id ? 'text-white' : 'text-gray-600'
            }`}
          >
            {item.label}
          </button>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-right">{course.duration}</span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-right">{course.lessons}</span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-right">{course.students.toLocaleString()}</span>
              </div>
            </div>
